...
if clientID!=-1:
	...
	while time.time()-startTime < 20:
		...
		mid = not mid
		right = not right
		print ('LeftSensor: ', left, 'MiddleSensor: ', mid, 'RightSensor: ', right)
		...
		if left:
			...
			errorCode=vrep.simxSetJointTargetVelocity(clientID, LeftJoint_handle, -50, vrep.simx_opmode_streaming)
			errorCode=vrep.simxSetJointTargetVelocity(clientID, RightJoint_handle, 50, vrep.simx_opmode_streaming)
		elif LASTSENSOR == 2:
			errorCode=vrep.simxSetJointTargetVelocity(clientID, LeftJoint_handle, 50, vrep.simx_opmode_streaming)
			errorCode=vrep.simxSetJointTargetVelocity(clientID, RightJoint_handle, -50, vrep.simx_opmode_streaming)
